...
def make_random_rectangle_mask(margin=10, bbox_min_size=30, bbox_max_size=100, min_times=0, max_times=3):
    height= 256
    width = 256
    mask = np.zeros((height, width), np.float32)
...
class RandomRectangleMaskGenerator:
    ...
    def __call__(self, img, iter_i=None, raw_image=None):
        ...
        return make_random_rectangle_mask(margin=self.margin, bbox_min_size=self.bbox_min_size,
